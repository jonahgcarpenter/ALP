// The navbar where we will give the user options to join the waitlist, send me an email directly within the site using a form, and a login button.

import React from "react";

const Navbar: React.FC = () => {
  return (
    <nav className="backdrop-blur-md bg-slate-900/95 p-6 grid grid-cols-3 items-center shadow-lg border-b border-slate-800 mb-8">
      <div>
