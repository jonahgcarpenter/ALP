...
const MeetTheBreeder: React.FC = () => {
    ...
    return (
        <div className="backdrop-blur-md bg-slate-900/95 p-8 max-w-7xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-12">
                <div className="md:w-2/4 flex justify-end">
                    <img 
                        src={ProfilePicture} 
                        alt="Breeder Profile" 
                        className="w-[80%] h-[400px] object-cover rounded-xl shadow-lg"
                    />
                </div>
                <div className="md:w-2/4 flex justify-start">
                    <div className="bg-slate-800 rounded-xl p-8 shadow-xl w-[80%]">
